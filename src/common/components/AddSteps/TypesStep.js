    ...
    return (
        <div>
            ...
            <RadioButtonGroup
                ...
                name="wine-type"
                valueSelected={wineType}>
                {types.map((type, index) => (
                    <RadioButton
                        labelStyle={{color: tinycolor(type.color)}}
                        key={index}
                        value={type.value}
                        label={type.label}
                    />
             ...
             <h2>Type</h2>
             <RadioButtonGroup
                 onChange={handleWineCategory}
                 name="wine-category"
                 valueSelected={wineCategory}>
              ...
              <RadioButtonGroup
                  onChange={handleBottleType}
                  name="bottle-type"
                  valueSelected={bottleType}>
